...
public sealed class AnimateTranslateLoop : MonoBehaviour
{
    ...
    [SerializeField] float leftWord;
    private float leftWorldX = default;

    [SerializeField] float rightWord;
    ...
    [SerializeField] Transform bgPosition;
    [SerializeField]
    ...
    private void Update()
    {
        ...
        rightWorldX = bgPosition.position.x + rightWord;
        leftWorldX = bgPosition.position.x + leftWord;
